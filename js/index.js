...
, function(e, t, n) {
    ...
    function f(e) {
        ...
        o()({
            ...
            r.apiResponse = t,
            ["invalid", "unaccepted", "spam", "aborted"].includes(n) ? s(e, n, r) : ["sent", "failed"].includes(n) && s(e, "mail".concat(n), r),
            s(e, "submit", r),
            t
        }
        )).then((function(t) {
      ...
      , v = function(e, t) {
        var n = function(n) {
            ...
            e.querySelectorAll(".wpcf7-form-control-wrap.".concat(n)).forEach((function(e) {
                ...
                e.querySelector('input[name="_wpcf7_quiz_answer_'.concat(n, '"]')).value = c
            }
            ))
        };
        for (var r in t)
